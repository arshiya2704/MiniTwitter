...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            //tweeter.tweet("arshiya", "first tweetdbjdhbkjsdshkbqdjabjdghsdfweuyjghksiuqwgdwbjhdsudgwuydgwudgwiudghduwigquqgduwidguiwegdiuwefgieuwfgiuewgfiuewgfuejdbwudhwuxdfsxhgfjhgkuggfdseasewsdzfxhgcj");
            tweeter.tweet("arshiya", "Hi, this is arshiya!");
            tweeter.follow("bob", "alex");
            tweeter.follow( "asim","arshiya");
            tweeter.follow("kamakshi","arshiya");
